...
/**
 * This code was copied from official TestRail API guide for connecting our tests with test rail
 * Unfortunately, integration with TestRail has to be done like this - they didn't provide some sort of library
 * We should not look to improve this code or change it even though it's not clean as it can be
 */
